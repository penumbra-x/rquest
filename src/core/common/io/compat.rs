...
///
/// This is currently used by `h2`, and by crate::core: internal unit tests.
#[derive(Debug)]
    ...
    T: crate::core::rt::Read,
{
    fn poll_read(
        ...
        let (new_init, new_filled) = unsafe {
            let mut buf = crate::core::rt::ReadBuf::uninit(tbuf.inner_mut());
            buf.set_init(init);
            buf.set_filled(filled);

            match crate::core::rt::Read::poll_read(self.p(), cx, buf.unfilled()) {
    ...
    T: crate::core::rt::Write,
{
    fn poll_write(
        ...
        crate::core::rt::Write::poll_write(self.p(), cx, buf)
    }

    fn poll_flush(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Result<(), std::io::Error>> {
        crate::core::rt::Write::poll_flush(self.p(), cx)
    }
    ...
    fn poll_shutdown(
        ...
        crate::core::rt::Write::poll_shutdown(self.p(), cx)
    }

    fn is_write_vectored(&self) -> bool {
        crate::core::rt::Write::is_write_vectored(&self.0)
    }
    ...
    fn poll_write_vectored(
        ...
        crate::core::rt::Write::poll_write_vectored(self.p(), cx, bufs)
    }
}

#[cfg(test)]
impl<T> crate::core::rt::Read for Compat<T>
where
...
#[cfg(test)]
impl<T> crate::core::rt::Write for Compat<T>
where
