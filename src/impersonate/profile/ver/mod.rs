...
pub(super) fn get_config_from_ver(ver: Impersonate) -> ImpersonateSettings {
    match ver {
        ...
        Impersonate::Chrome100 => v100::get_settings(ver.profile()),
        Impersonate::Chrome101 => v101::get_settings(ver.profile()),
        ...
        Impersonate::Safari16 => safari16::get_settings(ver.profile()),
        Impersonate::Safari16_5 => safari16_5::get_settings(ver.profile()),
